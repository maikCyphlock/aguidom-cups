...
export default function AtroposCard() {
  return (
    <div className="py-12 lg:p-12 ">

      <Atropos className="block w-[90vw] md:w-3/4 mx-auto rounded-2xl ">
        <div className="relative grid h-full gap-2 overflow-hidden border-2 border-yellow-400 rounded-xl bg-[#1A1A1B]">
          ...
          <div className="flex items-center justify-center flex-1 gap-2 mb-4">
            ...
            <div className="z-20 w-32 h-32 lg:w-56 lg:h-56 ">
              <TrophyIcon className={"antialiased"} />
            </div>
          ...
          <a href="#suscribe" className="z-20 py-2 font-bold text-center text-yellow-400 border-t border-b border-transparent border-yellow-400 hover:text-zinc-900 hover:bg-yellow-400 hover:bg-transparent ">Inscribirse</a>
