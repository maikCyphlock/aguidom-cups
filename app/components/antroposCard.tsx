...
export default function AtroposCard() {
  return (
    <div className="p-12 ">
      ...
      <Atropos className="block w-3/4 mx-auto rounded-2xl ">
        <div className="relative grid h-full gap-2 overflow-hidden border-2 border-yellow-500 rounded-2xl bg-zinc-950 ">
