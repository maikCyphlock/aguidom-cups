...
export default function Home() {
  return (
    <div className="bg-gradient-to-tr from-transparent to-indigo-950/20">
       <section className="container mx-auto ">
      <AtroposCard />
      <section className="grid max-w-5xl grid-cols-1 gap-8 mx-auto mb-12 lg:grid-cols-3">
        <LinearCard title={"¿qué es la copa Aguidom?"} className="col-span-2">
        ...
        <LinearCard title={"a tener en cuenta"}>
